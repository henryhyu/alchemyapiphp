...
class AlchemyAPI {
	...
	public function __construct($key = null)  {
		...
		$this->_ENDPOINTS['face_detection']['url'] = '/url/URLGetRankedImageFaceTags'; // for face recognition
		$this->_ENDPOINTS['face_detection']['image'] = '/image/ImageGetRankedImageFaceTags'; // for face recognition
	}
